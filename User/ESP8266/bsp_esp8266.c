...
static void ESP8266_USART_NVIC_Configuration ( void )
{
	...
	NVIC_PriorityGroupConfig( NVIC_PriorityGroup_2 );  // <-- 我改的地方 2
...
void USART1_IRQHandler(void)
{
	...
	{
		strEsp8266_Fram_Record .Data_RX_BUF [ strEsp8266_Fram_Record .InfBit .FramLength ++ ] = USART_ReceiveData ( macESP8266_USARTx );
	}

	if(USART_GetITStatus( macESP8266_USARTx, USART_IT_IDLE) != RESET)
	{
		macESP8266_USARTx->DR;
